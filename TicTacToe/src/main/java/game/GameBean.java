...
public class GameBean {
    ...
    public void playUserTurn(int line, int col) {
        if (line >= 0 && line < GRID_SIZE && col >= 0 && col < GRID_SIZE && gameStatus[line][col] == GameState.NULL) {
            this.play(GamePlayer.USER, line, col);
        } else {
            System.out.println("Posición inválida o ya ocupada. Por favor, elija otra.");
        }
    }
